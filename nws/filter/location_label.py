...
if __name__ == '__main__':
	lc = Location()
	ret = lc.label(u"杭州市近江家园六园17幢的楼下，消防队员正架着梯子爬往二楼的平台。")
	print ret[0], ret[1]
